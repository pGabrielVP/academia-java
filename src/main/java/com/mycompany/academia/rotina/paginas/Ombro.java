...
public class Ombro extends javax.swing.JPanel {
    ...
    private final List<String> exerciciosOmbro = Arrays.asList(
            "Elevação Lateral",
            "Elevação Frontal",
            ...
            "Elevação Lateral no Pulley Baixo",
     ...
     * @param rotinaDireita
     */
    public Ombro(RotinaEsquerda parent_window, RotinaDireita rotinaDireita) {
        ...
        botaoVoltar.addActionListener((e) -> {
            ...
            adicionarBotoes(exerciciosOmbro);
        });
    ...
    private void filtrarLista(String filtro) {
        if (!filtro.isBlank()) {
            ...
            for (String exercicio : exerciciosOmbro) {
