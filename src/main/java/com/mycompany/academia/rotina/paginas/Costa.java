 ...
 * @author paulo
 */
public class Costa extends javax.swing.JPanel {

    private final List<String> exerciciosCostas = Arrays.asList(
            "Levantamento Terra",
     ...
     * @param rotinaDireita
     */
    public Costa(RotinaEsquerda parent_window, RotinaDireita rotinaDireita) {
        ...
        adicionarBotoes(exerciciosCostas);
    ...
    private void filtrarLista(String filtro) {
        ...
        if (!filtro.isBlank()) {
            ...
            for (String exercicio : exerciciosCostas) {
