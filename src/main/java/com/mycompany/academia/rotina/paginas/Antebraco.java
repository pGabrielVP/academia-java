 ...
 * @author paulo
 */
public class Antebraco extends javax.swing.JPanel {

    private final List<String> exerciciosAntebraco = Arrays.asList(
            "Flexão de Punho no Pulley Baixo",
            "Extensão de Punho no Pulley Baixo",
            "Rosca Punho com Barra",
            "Rosca Punho Reversa com Barra",
    ...
    public Antebraco(RotinaEsquerda parent_window, RotinaDireita rotinaDireita) {
        ...
        adicionarBotoes(exerciciosAntebraco);
