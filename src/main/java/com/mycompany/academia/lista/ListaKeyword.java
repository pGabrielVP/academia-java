...
import com.mycompany.academia.datamodel.TableModelKeyword;
import com.mycompany.academia.edita.KeywordsEdita;
...
public class ListaKeyword extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle("Lista de Keywords");
        setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        setPreferredSize(new java.awt.Dimension(919, 565));

        ListaEntidades.setModel(new com.mycompany.academia.datamodel.TableModelKeyword());
    ...
    private void CriarEntidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CriarEntidadeActionPerformed
        ...
        KeywordsEdita entrada = new KeywordsEdita(new Keywords(), jDialog);
    ...
    private void EditarEntidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarEntidadeActionPerformed
        ...
        Keywords editando = controller.findKeywords(Integer.valueOf(ListaEntidades.getValueAt(ListaEntidades.getSelectedRow(), 0).toString()));
        KeywordsEdita entrada = new KeywordsEdita(editando, jDialog);
    ...
    private void DeletarEntidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeletarEntidadeActionPerformed
        try {
            ...
            Logger.getLogger(ListaKeyword.class.getName()).log(Level.SEVERE, null, ex);
        }
        // atualiza lista depois de deletar uma entidade
        ListaEntidades.setModel(new TableModelKeyword());
