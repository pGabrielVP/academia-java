...
import com.mycompany.academia.datamodel.TableModelExercicio;
...
public class ListaExercicio extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        ListaEntidades.setModel(new com.mycompany.academia.datamodel.TableModelExercicio());
    ...
    private void CriarEntidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CriarEntidadeActionPerformed
        ...
        ExercicioEdita entrada = new ExercicioEdita(new Exercicio(), jDialog);
    ...
    private void EditarEntidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarEntidadeActionPerformed
        ...
        Exercicio editando = controller.findExercicio(Integer.valueOf(ListaEntidades.getValueAt(ListaEntidades.getSelectedRow(), 0).toString()));
        ExercicioEdita entrada = new ExercicioEdita(editando, jDialog);
    ...
    private void DeletarEntidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeletarEntidadeActionPerformed
        try {
            ...
            Logger.getLogger(ListaExercicio.class.getName()).log(Level.SEVERE, null, ex);
        }
        // atualiza lista depois de deletar uma entidade
        ListaEntidades.setModel(new TableModelExercicio());
